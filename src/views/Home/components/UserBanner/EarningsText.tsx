...
export const getEarningsText = (
  ...
  if (numFarmsToCollect > 0 && hasCakePoolToCollect) {
    if (numFarmsToCollect > 1) {
      earningsText = t('%earningsBusd% to collect from %count% farms and 1UP pool', data)
    } else {
      earningsText = t('%earningsBusd% to collect from %count% farm and 1UP pool', data)
    }
    ...
    earningsText = t('%earningsBusd% to collect from 1UP pool', data)
  }
