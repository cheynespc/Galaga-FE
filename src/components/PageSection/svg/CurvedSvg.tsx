    ...
    <svg width="0" height="0">
      <defs>
        <clipPath id="topConvexCurve" clipPathUnits="objectBoundingBox">
          <path d="M 0,1 L 0,0 L 1,0 L 1,1 C 0.70 0, .20 0, 0 1 Z" />
        </clipPath>
      </defs>
    </svg>
  </ConvexContainer>
    ...
    <svg width="0" height="0">
      <defs>
        <clipPath id="bottomConvexCurve" clipPathUnits="objectBoundingBox">
          <path d="M 0,1 L 0,1 L 1,1 L 1,0 C .70 1, .20 1, 0 0 Z" />
        </clipPath>
      </defs>
    </svg>
  </ConvexContainer>
    ...
    <svg width="0" height="0">
      <defs>
        <clipPath id="bottomConcaveCurve" clipPathUnits="objectBoundingBox">
          <path d="M 0,1 L 0,0 L 1,0 L 1,1 C .70 0.1, .20 0.1, 0 1 Z" />
        </clipPath>
      </defs>
    </svg>
  </ConcaveContainer>
